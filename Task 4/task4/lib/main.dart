              ...
              children: [
                Column(
                  children: [
                    ...
                    Text('$teamAPoints', style: const TextStyle(fontSize: 120),),
                    ElevatedButton( onPressed: (){ setState(() {
                      teamAPoints++;
                                    ...
                                    child: const Text('+1 POINT', style: TextStyle(fontSize: 17),), ),
                    ...
                    ElevatedButton( onPressed: (){ setState(() {
                      teamAPoints+=2;
                                    ...
                                    child: const Text('+2 POINT', style: TextStyle(fontSize: 17)), ),
                    ...
                    ElevatedButton( onPressed: (){setState(() {
                      teamAPoints+=3;
                                    ...
                                    child: const Text('+3 POINT', style: TextStyle(fontSize: 17)), ),
                ...
                Column(
                  children: [
                    ...
                    Text('$teamBPoints', style: const TextStyle(fontSize: 120),),
                    ElevatedButton( onPressed: (){setState(() {
                      teamBPoints++;
                    });}, 
                                    style: ElevatedButton.styleFrom(
